...
export const userEmailActivateReducer = (state ={userEmailAddress:{ } }, action) => {
    switch(action.type){
        case USER_ACTIVATE_REQUEST:
            return { loading: true }
        
        case USER_ACTIVATE_SUCCESS:
            return { loading:false, success:true, userEmailAddress:action.payload }
